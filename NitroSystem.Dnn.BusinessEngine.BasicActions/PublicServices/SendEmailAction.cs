...
{
    public class SendEmailAction : ActionBase<SendEmailInfo>, IAction
    {
        public SendEmailAction()
        {
            this.OnActionCompletedEvent += SendEmailAction_OnActionCompletedEvent;
        }

        public SendEmailAction(IServiceWorker serviceWorker, IActionWorker actionWorker, ActionDto action)
        {
        ...
        private void SendEmailAction_OnActionCompletedEvent(object sender, ActionEventArgs e)
        {
        }
    }
}
